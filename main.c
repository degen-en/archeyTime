...
void showTime(long timeMinus, time_t seconds, char style)
{
    ...
    /*The code is pretty straightforward. It defines the time units and then calculates the number of each unit since January 1, 1970. 
    The code is compiled with the following command: 
    "gcc main.c -o exe" in core folder
